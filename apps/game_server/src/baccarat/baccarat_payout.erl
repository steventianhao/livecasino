...
reward4plus(#{?BANKER_POS_1 := B1,?BANKER_POS_2 := B2,?BANKER_POS_3 := B3,?PLAYER_POS_1 := P1,?PLAYER_POS_2 := P2,?PLAYER_POS_3 := P3},Func)->
	reward_morethan4([B1,B2,B3],[P1,P2,P3],Func);
reward4plus(#{?BANKER_POS_1 := B1,?BANKER_POS_2 := B2,?BANKER_POS_3 := B3,?PLAYER_POS_1 := P1,?PLAYER_POS_2 := P2},Func)->
	reward_morethan4([B1,B2,B3],[P1,P2],Func);
reward4plus(#{?BANKER_POS_1 := B1,?BANKER_POS_2 := B2,?PLAYER_POS_1 := P1,?PLAYER_POS_2 := P2,?PLAYER_POS_3 := P3},Func)->
